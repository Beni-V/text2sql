    ...
    def _process_retrieved_documents(self, docs: List[Document]) -> Dict[str, Any]:
                ...
                for line in lines:
                    if ":" in line and not line.startswith("Table:"):
                        ...
                        if "," in col_details:
                            ...
                            is_nullable = (
                                "YES" if "nullable" in nullable_part.lower() else "NO"
                            )
                        else:
        ...
        for doc in docs:
            ...
            if doc_type == "foreign_key":
                ...
                schema[source_table]["relationships"]["foreign_keys"].append(
                    foreign_key_info
                )
                ...
                schema[target_table]["relationships"]["referenced_by"].append(
                    referenced_by_info
                )
